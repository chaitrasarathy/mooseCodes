...
sys.path.append('/home/sarathy/Work/moose/Demos/util')
...
morphPath = '/home/sarathy/Work/myCodes/cells'
for i in os.listdir(morphPath):
    if i.endswith('.swc'):
        elecFileNames.append(i)
...
def main():
    ...
    #for bb in os.listdir("/home/sarathy/Work/sample/modelNelec/cells"):
	#opFileName = bb.split('.')[0] + '.txt'
    #analyzeSyn(opFileName)
